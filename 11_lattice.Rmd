...
```{r eval=FALSE, fig.width=fig.width_lattice*2, fig.height=fig.height_lattice*2}
...
```{r lmatchdotplotref, fig.cap="Dotplot of the line matching dataset, with horizontal reference line", fig.width=fig.width_lattice*2, fig.height=fig.height_lattice*2}
dotplot(error ~ length | group, groups=color, 
        data=dats, origin=0, ylab="Error (cm)", 
