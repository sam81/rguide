...
```{r timewlines, fig.cap="Values connected by lines."}
ti = 1:50
b = rnorm(15, 4.3, n=50)
plot(ti, b, type="l")
```
...
```{r drawfunction, fig.cap="Drawing a mathematical function."}
...
```{r sincos, fig.cap="Sine and cosine functions with `matplot`."}
...
```{r barplotsimple, fig.cap="Simple barplot."}
...
```{r barplotbars, fig.cap="Barplot with error bars."}
...
```{r boxplot1, fig.cap="Boxplots comparing the distribution for two groups."}
...
```{r hist, fig.cap="Frequency distribution of a random sample."}
...
```{r stripchart1, fig.cap="Stripchart example."}
...
```{r int, fig.cap="Interaction plot with different line types.", fig.width=fig.width*1, fig.height=fig.height*1}
...
```{r intmanleg, fig.cap="Interaction plot with manual legend.", fig.width=fig.width*1.1, fig.height=fig.height*1}
par(oma=c(0, 0, 0, 2.2))
interaction.plot(x.factor=ToothGrowth$supp,
                 trace.factor=ToothGrowth$dose,
                 response=ToothGrowth$len,
...
```{r intb, fig.cap="Interaction plot with different line types and different symbols.", fig.width=fig.width*1.1, fig.height=fig.height*1}
...
```{r lty, echo=FALSE, fig.cap="The six default line types in R", fig.width=fig.width*1.1, fig.height=fig.height*1.5}
lwid=1.5
plot.new()
...
```{r pch, echo=FALSE, fig.cap="Plotting symbols from 0 to 25", fig.width=fig.width*1.35, fig.height=fig.height*1.5}
...
```{r chfontstyle, fig.cap="Changing font style.", fig.width=fig.width*1, fig.height=fig.height*1}
x = seq(0, 2*pi, 0.1)
y = sin(x)
par(font=3)
...
```{r chfontstyle2, fig.cap="Changing font style for other textual elements.", fig.width=fig.width*1, fig.height=fig.height*1}
...
```{r figuremono, fig.cap="Changing font family"}
par(family="mono")
...
```{r figurepalatino, fig.cap="Plot with Palatino font"}
...
Not all graphics devices have access to all installed system fonts. For workarounds see Chapter \@ref(fonts).
```
...
```{r irislegend1, fig.cap='Plot with legend for plotting symbols.'}
data(iris)
...
```{r irislegend2, fig.cap='Plot with legend for plotting symbols and colors.'}
...
```{r barplotlegend, fig.cap="Barplot with a legend outside the plot.", fig.width=fig.width*2, fig.height=fig.height*1}
data(HairEyeColor)
par(mfrow=c(1,2))
...
```{r figureregion, echo=FALSE, fig.cap="The figure region includes the plotting region and the margins.", fig.width=fig.width*1.05, fig.height=fig.height*1}
par(bg="slategray")
plot.new()
...
```{r figureregionsubplot, echo=FALSE, fig.cap="Device with outer margins and multiple figure regions.", fig.width=fig.width*1.5, fig.height=fig.height*1.5}
par(bg="slategray")
plot.new()
plot.window(xlim=c(0,10), ylim=c(0,10))
par(mfrow=c(2,2))
...
```{r color1, echo=FALSE, fig.cap="Some built-in colors in R."}
...
```{r coltransp, fig.cap="Color opacity"}
...
```{r, fig.height=fig.height*2, fig.width=fig.width*2}
