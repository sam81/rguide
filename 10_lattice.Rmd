...
```{r lmatchdotplot, fig.cap="Dotplot of the line matching dataset.", fig.width=fig.width_lattice*1.5, fig.height=fig.height_lattice*1.5}
...
```{r lmatchdotplotref, fig.cap="Dotplot of the line matching dataset, with a horizontal reference line.", fig.width=fig.width_lattice*1.5, fig.height=fig.height_lattice*1.5}
dotplot(error ~ length | group, groups=color, 
        data=dat, origin=0, ylab="Error (cm)", 
