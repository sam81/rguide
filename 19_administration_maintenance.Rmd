...
run configure:
```{bash eval=FALSE}
./configure --prefix=/path/to/install_loc/ --with-cairo --with-jpeglib --with-readline --with-tcltk --enable-R-profiling --enable-R-shlib --enable-memory-profiling --with-blas --with-lapack
```
