...
```{r plotgrid1, fig.cap="Multi-panel figure arranged and labeled with the `plot_grid` function.", message=FALSE, fig.width=fig.width*1.5, fig.height=fig.height*0.8}
...
```{r lattplotgrid1, fig.cap="Multi-panel figure arranged and labeled with the `plot_grid` function.", message=FALSE, fig.width=fig.width*1.5, fig.height=fig.height*0.8}
library(lattice)
...
```{r lattfiglab1, fig.cap="`lattice` panels with labels.", fig.width=fig.width*1.5, fig.height=fig.height*0.8}
